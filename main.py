...
class UI_MainWindow(QtWidgets.QWidget):
    def __init__(self, MainWindow):
        ...
        MainWindow.setWindowFlags(MainWindow.windowFlags() | QtCore.Qt.MSWindowsFixedSizeDialogHint)     
        ...
        font = QtGui.QFont()
        font.setFamily("Roboto ExtraBold")
...
if __name__ == "__main__":
    ...
    dir_ = QtCore.QDir("Fonts/Roboto")
    _id = QtGui.QFontDatabase.addApplicationFont("Fonts/Roboto/Roboto-Regular.ttf")
